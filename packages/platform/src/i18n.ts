...
Object.assign(EN, {
  ...
  "cmd.keybindings.usage": "[<action> [<key>]]",
  "cmd.keybindings.desc": "view or rebind terminal keybindings (action -> key); persists to settings.local.json ui.keybindings and restores on restart",
  "repl.keybindings.list": "[keybindings] current bindings (action = key):",
  "repl.keybindings.switched": "[keybindings] {action} rebound to {value} (persisted to .standardcode/settings.local.json; restored on restart)",
  "repl.keybindings.err.unknownAction": "unknown keybinding action: {value} (expected one of: permission.cycle)",
  "repl.keybindings.err.conflict": "keybinding conflict: {value} is already bound to another action",
  "repl.keybindings.err.invalidKey": "invalid key spec: {value} (chord sequences and unknown key names are rejected)",
...
Object.assign(ZH_CN, {
  ...
  "cmd.keybindings.usage": "[<动作> [<键位>]]",
  "cmd.keybindings.desc": "查看或重绑定终端键位（动作 -> 键位）；持久化到 settings.local.json 的 ui.keybindings，重启后恢复",
  "repl.keybindings.list": "[keybindings] 当前键位（动作 = 键位）：",
  "repl.keybindings.switched": "[keybindings] {action} 已重绑定为 {value}（已持久化到 .standardcode/settings.local.json；重启后恢复）",
  "repl.keybindings.err.unknownAction": "未知键位动作：{value}（应为其中之一：permission.cycle）",
