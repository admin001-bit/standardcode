...
2. **Q-6「Bun 作运行时的取舍」→ 结案：维持"仅作打包器"定位；M7 期实选型=Bun compile，最终定案随 BLK-09 落 mini-ADR。**
...
4. **Q-8「/goal /btw /branch 等长尾命令去留」→ 结案：M6 复审已裁（BLK-06=①），四件延后件已落 M7 本板，命令面自此闭合。**
...
- v2.8 §14.2 行 584-588（Q-5~Q-9 原文/倾向）、§2 行 115、§0.5 B-06、附录 E 行 630、§3 行 131、§12.6 验证级别。
