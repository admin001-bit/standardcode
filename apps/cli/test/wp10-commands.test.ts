...
describe("DoD④ 两命令 Tab 补全", () => {
  it("/st 唯一命中 /status；/us 唯一命中 /usage、/u 双义（insert 面）；候选列表含前缀重叠件；命令全集恰 35【勘误链 2026-09-14/15 至 30；2026-09-19：M7-WP-01 /goal 30→31；2026-09-23：M7-WP-03 /theme 31→32、M7-WP-04 /keybindings 32→33、M7-WP-06 /sandbox 33→34、M7-WP-08 /release-notes 34→35】", () => {
